...
namespace GoSteamLanguageGenerator
{
	public class GoGen
	{
		...
		public void EmitClasses(Node root, StringBuilder sb)
		{
			...
			sb.AppendLine("    \"github.com/softashell/go-steam/steamid\"");
			sb.AppendLine("    \"github.com/softashell/go-steam/rwu\"");
			sb.AppendLine("   . \"github.com/softashell/go-steam/_internal/protobuf\"");
			sb.AppendLine(")");
			sb.AppendLine();
